...
@st.cache_resource
def get_data():
    FILEPATH = "https://github.com/michielsd/findo_backup/raw/refs/heads/main/data/begroting_batenlasten.pickle"
...
with search_container:
    ...
    with col2:
        st.title("Data taakvelden begroting")
    ...
    with col1:
        ...
        st.download_button(
            ...
            data=excel_buffer,
            file_name="taakvelden_begroting_data.xlsx",
